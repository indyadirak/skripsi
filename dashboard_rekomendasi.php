...
$query = 'SELECT rekomendasi.nomor, perangkat.ip, kerentanan.kerentanan, rekomendasi.rekomendasi FROM perangkat INNER JOIN kerentanan ON perangkat.nomor = kerentanan.ip INNER JOIN rekomendasi ON kerentanan.nomor = rekomendasi.nomor_kerentanan;';
$stmt = $conn->prepare($query);
$stmt->execute();
...
<!-- 								<a class="dropdown-item" href="pages-profile.html"><i class="align-middle me-1" data-feather="user"></i> Profile</a>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">recommendations dashboard </h1>
					<h5 class="card-title mb-0">menampilkan informasi seputar rekomendasi yang digunakan untuk menanggulangi kerentanan yang ada</h5>
					<br>
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								<br>
								<div class="card-header position-absolute top-0 end-0"><a href="./menambahkan_rekomendasi.php" class="btn btn-primary position-absolute top-50 end-0 translate-middle-y">Tambah rekomendasi</a>
								<br>								</div>
								<br>
								<br>
								<div class="card-body">
